                    ...
                    <div className="flex flex-col px-2 -mx-4 md:flex-row md:mx-10 md:py-0">
                        {
                            categories.map((item: string) => {
                                return(
                                    <a href="#" className="px-2.5 py-2 text-gray-700 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 md:mx-2" onClick={()=>onClickItem(item)}>{item}</a>                         
                                )
                            })
                        }
                    </div>
